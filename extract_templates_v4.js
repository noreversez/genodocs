...
const filePaths = [
  { path: 'C:\\Users\\NB\\OneDrive\\Desktop\\ฝึกงานบางซื่อ\\1พ.ต.ท.สุภัทร เหมจินดา68-1-1\\3ประจำวัน67-12-12\\1ปจว.คดีอาญาฯ.xls', tagPrefix: 'อาญา', minLen: 120 },
  { path: 'C:\\Users\\NB\\OneDrive\\Desktop\\ฝึกงานบางซื่อ\\1พ.ต.ท.สุภัทร เหมจินดา68-1-1\\3ประจำวัน67-12-12\\2ปจว.คดีจราจร.xls', tagPrefix: 'จราจร', minLen: 80 }
];
...
for (const fp of filePaths) {
  if (!fs.existsSync(fp.path)) {
    console.error('File not found:', fp.path);
    continue;
  }
  ...
  for (const sheetName of workbook.SheetNames) {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      if (content) {
        // filter out garbage strings that are just repeated headers
